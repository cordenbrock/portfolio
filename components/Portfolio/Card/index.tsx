  ...
  const appImg = () => {
    switch (img) {
      ...
      case "paro":
        ...
        break;
      case "exchangerator":
        return "bg-exchangerator";
        break;
      default:
        return "bg-clear-black";
    }
  };

  return (
    <div
      className={`relative w-full h-64 overflow-hidden transition duration-300 ease-in-out bg-center bg-cover rounded shadow-lg group hover:shadow-2xl
        ${appImg()}`}
    >
